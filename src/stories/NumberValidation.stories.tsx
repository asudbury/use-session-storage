...
const NumberValidationExample = () => {
  ...
  const [score, setScore, { loading, error, remove, reset }] =
    useSessionStorage("game-score", 50, { validator });
    ...
    <div style={storyStyles.container}>
      ...
      <div style={storyStyles.gradientHeader}>
        ...
        <div style={{ fontSize: "1.1rem", color: "#fff", marginTop: 4 }}>
          Number validation with range constraints. Demonstrates type checking
