...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Number validation with range constraints. Demonstrates type checking and range validation.',
      },
    },
  },
};
...
const NumberValidationExample = () => {
  ...
  const [score, setScore, { loading, error, remove, reset }] = useSessionStorage(
    'game-score',
    50,
    { validator }
  );
  ...
  return (
    <div style={storyStyles.container}>
      ...
      <div style={{ marginBottom: '10px', marginTop: '20px' }}>
        ...
        />
        <button onClick={handleSubmit} style={{ ...getButtonStyle('primary'), marginLeft: '10px' }}>Update</button>
      </div>
