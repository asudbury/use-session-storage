    ...
    <div style={storyStyles.container}>
      ...
      <div style={storyStyles.gradientHeader}>
        ...
        <p style={storyStyles.gradientHeaderSubtitle}>
          A powerful React hook for SessionStorage management with comprehensive serialization support and type safety
        </p>
      </div>
      ...
      <div style={{
        ...
        <ul style={{ paddingLeft: '0', lineHeight: '1.8', fontSize: '16px', listStyle: 'none' }}>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            ...
            <span><strong>Automatic Serialization</strong>: JSON serialization/deserialization with error handling</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
          ...
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            ...
            <span><strong>Performance Optimized</strong>: Efficient state management and memory leak prevention</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Event Handling</strong>: Listen to storage changes across tabs/windows</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Default Values</strong>: Support for default values and fallbacks</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Validation</strong>: Optional value validation with custom validators</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>SSR Safe</strong>: Server-side rendering compatible</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Synchronization</strong>: Automatic sync across multiple hook instances</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Debounced Updates</strong>: Optional debounced writes for performance</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>State Management</strong>: Comprehensive loading and error states</span>
          </li>
        </ul>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' }}>
            ...
            <h3 style={{ margin: 0, color: '#2d3748', fontSize: '20px', fontWeight: '600' }}>Synchronized</h3>
          </div>
          <p style={{ margin: 0, color: '#4a5568', lineHeight: '1.6' }}>Automatic synchronization across multiple hook instances and tabs for seamless state management.</p>
        </div>
      </div>
